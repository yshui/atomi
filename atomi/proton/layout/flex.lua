...
--
--
--![Usage example](../images/AUTOGEN_proton_layout_defaults_flex.svg)
--
-- @usage
--proton.widget {
...
-- @function proton.layout.flex.horizontal
...
-- equally among all widgets. Widgets can be added via :add(widget).
-- @tparam widget ... Widgets that should be added to the layout.
-- @function proton.layout.flex.vertical
