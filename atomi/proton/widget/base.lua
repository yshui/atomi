...
-- @function proton.widget.base.rect_to_device_geometry
...
-- @function proton.widget.base.fit_widget
...
-- @function proton.widget.base.layout_widget
...
-- called directly.
-- @function proton.widget.base.handle_button
...
-- @function proton.widget.base.place_widget_via_matrix
...
--   after applying the transformation matrix.
-- @return An opaque object that can be returned from :layout()
-- @function proton.widget.base.place_widget_at
...
function base.widget:setup(args)
    ...
    f(self,w)
    if id then
        -- Avoid being dropped by proton metatable -> drawin
        rawset(self, id, w)
    end
...
-- See [The declarative layout system](../documentation/03-declarative-layout.md.html)
-- @param args An array containing the widgets disposition
-- @function proton.widget.base.make_widget_declarative
...
-- @see fit_widget
-- @function proton.widget.base.make_widget
...
-- @function proton.widget.base.empty_widget
...
-- @function proton.widget.base.check_widget
