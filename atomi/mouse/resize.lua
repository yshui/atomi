...
--
-- @function atomi.mouse.resize.set_mode
...
-- @function atomi.mouse.resize.add_enter_callback
...
-- @function atomi.mouse.resize.add_move_callback
-- @tparam function cb The callback (or nil)
-- @tparam[default=other] string context The callback context
...
-- @function atomi.mouse.resize.add_leave_callback
-- @tparam function cb The callback (or nil)
-- @tparam[default=other] string context The callback context
