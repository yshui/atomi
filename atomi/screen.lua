...
-- we use require("atomi.client") inside functions to prevent circular dependencies.
local client
...
-- @deprecated atomi.screen.getdistance_sq
-- @param s Screen
...
function screen.getdistance_sq(s, x, y)
    util.deprecate("Use s:get_square_distance(x, y) instead of atomi.screen.getdistance_sq")
...
-- `screen` table/object.
-- @function atomi.screen.getbycoord
...
--- Give the focus to a screen, and move pointer to last known position on this
-- screen, or keep position relative to the current focused screen
-- @function atomi.screen.focus_bydirection
...
--- Give the focus to a screen, and move pointer to last known position on this
-- screen, or keep position relative to the current focused screen
-- @function atomi.screen.focus_relative
...
-- @deprecated atomi.screen.padding
...
function screen.padding(_screen, padding)
    util.deprecate("Use _screen.padding = value instead of atomi.screen.padding")
    if padding then
...
--- The defaults arguments for `atomi.screen.focused`
-- @tfield[opt=nil] table atomi.screen.default_focused_args

--- Get the focused screen.
--
-- It is possible to set `atomi.screen.default_focused_args` to override the
-- default settings.
--
-- @function atomi.screen.focused
...
-- @function atomi.screen.connect_for_each_screen
...
-- @function atomi.screen.disconnect_for_each_screen
