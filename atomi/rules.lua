...
local a_place = require("atomi.placement")
...
--- Apply atomi.rules.rules to a client.
-- @client c The client.
...
--
--    function atomi.rules.extra_properties.my_new_property(c, value, props)
--        -- do something
--    end
--
...
-- * switchtotag
--
-- @tfield table atomi.rules.extra_properties
...
-- To add a new properties, just do:
--
--    function atomi.rules.high_priority_properties.my_new_property(c, value, props)
--        -- do something
--    end
--
-- By default, the table has the following functions:
...
-- * new_tag
--
-- @tfield table atomi.rules.high_priority_properties
