...
local tags = require("atomi.tag")
local keygrabber = require("atomi.keygrabber")
local client_iterate = require("atomi.client").iterate
...
-- @param args.new (Default: atomi.menu.entry) The menu entry constructor.
...
--- Default atomi.menu.entry constructor
...
--
-- * Key items: Table containing the displayed items. Each element is a table by default (when element 'new' is atomi.menu.entry) containing: item name, triggered action, submenu table or function, item icon (optional).
...
--     if atomi.rules.match(c, {class = "URxvt"}) then
--       terms[i] =
--         {c.name,
--          function()
