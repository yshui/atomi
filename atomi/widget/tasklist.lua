---------------------------------------------------------------------------
--- Tasklist widget module for atomi
--
-- @author Julien Danjou &lt;julien@danjou.info&gt;
-- @copyright 2008-2009 Julien Danjou
-- @release v3.5.2-1890-ge472339
-- @classmod atomi.widget.tasklist
---------------------------------------------------------------------------
...
local function tasklist_label(c, args, tb)
    ...
    tb:set_font(ugly.get_font(font))
...
local function tasklist_update(s, w, buttons, filter, data, style, update_function)
    ...
    update_function(w, nil, ugly.x.get_dpi(s), buttons, label, data, clients)
end
...
--   update. See `atomi.widget.common.list_update`.
-- @tparam[opt] table base_widget Container widget for tag widgets. Default
--   is `proton.layout.flex.horizontal`.
