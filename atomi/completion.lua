...
--- Enable programmable bash completion in atomi.completion.bash at the price of
-- a slight overhead.
...
-- For this function to run properly the atomi.completion.keyword table should
