...
--
-- function resize(c)
--   local grabber = atomi.keygrabber.run(function(mod, key, event)
--     if event == "release" then return end
--
--     if     key == 'Up'    then atomi.client.moveresize(0, 0, 0, 5, c)
--     elseif key == 'Down'  then atomi.client.moveresize(0, 0, 0, -5, c)
--     elseif key == 'Right' then atomi.client.moveresize(0, 0, 5, 0, c)
--     elseif key == 'Left'  then atomi.client.moveresize(0, 0, -5, 0, c)
--     else   atomi.keygrabber.stop(grabber)
--     end
--   end)
-- end
