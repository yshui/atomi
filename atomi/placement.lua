...
--    local f = (atomi.placement.right + atomi.placement.left)
--    f(client.focus)
--
--
--
...
--    
--    local f = atomi.placement.scale
--      + atomi.placement.left
--      + (axis and atomi.placement['maximize_'..axis] or nil)
--    
...
-- `atomi.placement.restore` by setting the right `context` argument.
--
...
local client = require("atomi.client")
local layout = require("atomi.layout")
local a_screen = require("atomi.screen")
...
--
--    (atomi.placement.no_overlap + atomi.placement.no_offscreen)(c)
--
...
--atomi.placement.closest_corner(mouse, {include_sides=true, parent=c})
-- 
-- -- It is possible to emulate the mouse API to get the closest corner of
-- -- random area
--local _, corner = atomi.placement.closest_corner(
...
--
-- @usage
--atomi.placement.no_offscreen(c)--, {honor_workarea=true, margins=40})
-- @client c The client.
...
--
-- @usage
--atomi.placement.no_overlap(client.focus)
...
--
-- @usage
--atomi.placement.under_mouse(client.focus)
...
--
-- @usage
--atomi.placement.next_to_mouse(client.focus)
...
function placement.next_to_mouse(c, offset)
    c = c or capi.client.focus
    offset = offset or dpi(5, c.screen)
...
--
-- @usage
--atomi.placement.top_left(client.focus)
...
--
-- @usage
--atomi.placement.top_right(client.focus)
...
--
-- @usage
--atomi.placement.bottom_left(client.focus)
...
--
-- @usage
--atomi.placement.bottom_right(client.focus)
...
--
-- @usage
--atomi.placement.left(client.focus)
...
--
-- @usage
--atomi.placement.right(client.focus)
...
--
-- @usage
--atomi.placement.top(client.focus)
...
--
-- @usage
--atomi.placement.bottom(client.focus)
...
--
-- @usage
--atomi.placement.centered(client.focus)
...
--
-- @usage
--atomi.placement.center_vertical(client.focus)
...
--
-- @usage
--atomi.placement.center_horizontal(client.focus)
