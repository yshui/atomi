...
-- Functions
client.urgent = require("atomi.client.urgent")
client.swap = {}
client.floating = {}
client.dockable = {}
client.property = {}
client.shape = require("atomi.client.shape")
client.focus = require("atomi.client.focus")

--- Jump to the given client.
-- Takes care of focussing the screen, the right tag, etc.
--
-- @deprecated atomi.client.jumpto
-- @see client.jump_to
...
function client.jumpto(c, merge)
    util.deprecate("Use c:jump_to(merge) instead of atomi.client.jumpto")
...
--
-- @deprecated atomi.client.visible
-- @see screen.clients
...
-- @function atomi.client.swap.bydirection
...
-- @function atomi.client.swap.global_bydirection
...
-- @function atomi.client.swap.byidx
-- @param i The index.
...
--
-- @legacylayout atomi.client.getmaster
...
--
-- @legacylayout atomi.client.setmaster
...
-- @legacylayout atomi.client.setslave
...
-- @deprecated atomi.client.moveresize
...
function client.moveresize(x, y, w, h, c)
    util.deprecate("Use c:relative_move(x, y, w, h) instead of atomi.client.moveresize")
...
-- @deprecated atomi.client.movetotag
...
function client.movetotag(target, c)
    util.deprecate("Use c:move_to_tag(target) instead of atomi.client.movetotag")
...
-- @deprecated atomi.client.toggletag
...
function client.toggletag(target, c)
    util.deprecate("Use c:toggle_tag(target) instead of atomi.client.toggletag")
...
-- @deprecated atomi.client.movetoscreen
...
function client.movetoscreen(c, s)
    util.deprecate("Use c:move_to_screen(s) instead of atomi.client.movetoscreen")
...
-- @function atomi.client.getmarked
...
-- @client c The client.
-- @deprecated atomi.client.isfixed
-- @see is_fixed
-- @see size_hints_honor
function client.isfixed(c)
    util.deprecate("Use c.is_fixed instead of atomi.client.isfixed")
    c = c or capi.client.focus
...
-- @deprecated atomi.client.floating.toggle
-- @client c A client.
-- @see floating
...
--
-- @legacylayout atomi.client.setwfact
...
--
-- @legacylayout atomi.client.incwfact
...
--   "toolbar" or "dock"
-- @deprecated atomi.client.dockable.get
function client.dockable.get(c)
    util.deprecate("Use c.dockable instead of atomi.client.dockable.get")
...
-- @deprecated atomi.client.dockable.set
function client.dockable.set(c, value)
    util.deprecate("Use c.dockable = value instead of atomi.client.dockable.set")
...
-- @return The property.
-- @deprecated atomi.client.property.get
function client.property.get(c, prop)
    if not client.data.persistent_properties_loaded[c] then
        ...
        for p in pairs(client.data.persistent_properties_registered) do
            local value = c:get_xproperty("atomi.client.property." .. p)
            if value ~= nil then
...
function client.property.set(c, prop, value)
    ...
    if client.data.properties[c][prop] ~= value then
        if client.data.persistent_properties_registered[prop] then
            c:set_xproperty("atomi.client.property." .. prop, value)
        end
...
--
-- @function atomi.client.iterate
-- @usage -- un-minimize all urxvt instances
-- local urxvt = function (c)
--   return atomi.rules.match(c, {class = "URxvt"})
-- end
--
-- for c in atomi.client.iterate(urxvt) do
--   c.minimized = false
-- end
...
--
-- @function atomi.client.run_or_raise
-- @usage -- run or raise urxvt (perhaps, with tabs) on modkey + semicolon
-- atomi.key({ modkey, }, 'semicolon', function ()
--     local matcher = function (c)
--         return atomi.rules.match(c, {class = 'URxvt'})
--     end
--     atomi.client.run_or_raise('urxvt', matcher)
-- end);
...
-- @deprecated atomi.client.get_transient_for_matching
...
function client.get_transient_for_matching(c, matcher)
    util.deprecate("Use c:get_transient_for_matching(matcher) instead of"..
        "atomi.client.get_transient_for_matching")
...
-- @deprecated atomi.client.is_transient_for
...
do
    ...
    --
    -- See `atomi.client.focus.history.enable_tracking` to enable it again.
    -- @treturn int The internal value of `disabled_count` (calls to this
    --   function without calling `atomi.client.focus.history.enable_tracking`).
    -- @function atomi.client.focus.history.disable_tracking
    ...
    -- through `atomi.client.focus.history.disable_tracking`.
    -- @treturn boolean True if history tracking has been enabled.
    -- @function atomi.client.focus.history.enable_tracking
    ...
    -- @function atomi.client.focus.history.is_enabled
