...
-- @function atomi.client.focus.history.delete
...
--
-- @function atomi.client.focus.byidx
-- @param i The index.
...
-- @function atomi.client.focus.filter
...
-- @function atomi.client.focus.history.add
...
--   first iteration, `atomi.client.focus.filter` is used by default to get any
--   client.
-- @treturn client.object A client.
-- @function atomi.client.focus.history.get
...
-- @function atomi.client.focus.history.previous
...
-- @function atomi.client.focus.bydirection
...
-- @client[opt] c The client.
-- @tparam[opt=false] boolean stacked Use stacking order? (top to bottom)
-- @function atomi.client.focus.global_bydirection
